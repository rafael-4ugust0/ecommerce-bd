...
CREATE TABLE `tipo_endereco` (
  `CodigoTpEnder` smallint NOT NULL,
  `DescrTpEnder` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`CodigoTpEnder`)
...
INSERT INTO `tipo_endereco` VALUES (1,'Avenida'),(2,'Rua'),(3,'Praca'),(4,'Travessa'),(5,'Rodovia');
...
-- Dump completed on 2022-05-03 13:50:10
